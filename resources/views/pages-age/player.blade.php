        ...
        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
            <div class="row">
                <div class="container">
                    ...
                    <div class="row">
                            <div class="col-md-4">
                                <h1 id="player-name"> {{ $profile_data[0]['name'] }} | {{ $profile_data[0]['rating'] }}</h1>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="player-card"> {{-- Win Rate --}}
                                <div class="card card-stats mb-4 mb-lg-0">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col">
                                                <h5 class="card-title text-uppercase text-muted mb-0">Win Rate</h5>
                                                <span class="h2 font-weight-bold mb-0">{{ round($profile_data[0]['wins']*100/($profile_data[0]['wins'] + $profile_data[0]['losses']), 1) }}</span>
                                            </div>
                                            <div class="col-auto">
                        ...
                        <div class="col-md-3">
                            <div class="player-card"> {{-- Total Games --}}
                                <div class="card card-stats mb-4 mb-lg-0">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col">
                                                <h5 class="card-title text-uppercase text-muted mb-0">Matches</h5>
                                                <span class="h2 font-weight-bold mb-0">{{ $profile_data[0]['games'] }}</span>
                                            </div>
                                            <div class="col-auto">
                        ...
                        <div class="col-md-3">
                            <div class="player-card"> {{-- Wins --}}
                                <div class="card card-stats mb-4 mb-lg-0">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col">
                                                <h5 class="card-title text-uppercase text-muted mb-0">Wins</h5>
                                                <span class="h2 font-weight-bold mb-0">{{ $profile_data[0]['wins'] }}</span>
                                            </div>
                                            <div class="col-auto">
                        ...
                        <div class="col-md-3">
                            <div class="player-card"> {{-- Losses --}}
                                <div class="card card-stats mb-4 mb-lg-0">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col">
                                                <h5 class="card-title text-uppercase text-muted mb-0">Losses</h5>
                                                <span class="h2 font-weight-bold mb-0">{{ $profile_data[0]['losses'] }}</span>
                                            </div>
                                            <div class="col-auto">
